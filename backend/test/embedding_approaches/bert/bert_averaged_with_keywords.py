...
def bert_averaged_embeddings_with_keywords(supervisors, supervisors_db):
    """
    Evaluates supervisor proposals using BERT averaged embeddings with keywords approach.
    ...
    Returns:
        The Mean Reciprocal Rank (MRR) score for the BERT embedding approach with keywords.
    """
    def embed(text):
    ...
    def calculate_suggestions(embedding, supervisors):
        ...
        for supervisor in supervisors:
            embedding_str = supervisor.get('bert_averaged_embedding_with_keywords', [])
