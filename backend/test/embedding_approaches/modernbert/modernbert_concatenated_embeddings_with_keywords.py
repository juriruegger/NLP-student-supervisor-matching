...
def modernbert_concatenated_embeddings_with_keywords(supervisors, supervisors_db):
    """
    Evaluates supervisor proposals using ModernBERT concatenated embeddings with keywords approach.
    ...
    Returns:
        The Mean Reciprocal Rank (MRR) score for the ModernBERT concatenated embedding approach with keywords.
    """
    def embed(text):
    ...
    def calculate_suggestions(embedding, supervisors):
        ...
        for supervisor in supervisors:
            embedding_str = supervisor.get('modernbert_concatenated_embedding_with_keywords', [])
