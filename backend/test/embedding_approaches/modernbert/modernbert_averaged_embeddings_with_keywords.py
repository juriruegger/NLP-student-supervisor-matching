...
def modernbert_averaged_embeddings_with_keywords(supervisors, supervisors_db):
    """
    Evaluates supervisor proposals using ModernBERT averaged embeddings with keywords approach.
    ...
    Returns:
        The Mean Reciprocal Rank (MRR) score for the ModernBERT embedding approach with keywords.
    """
    def embed(text):
