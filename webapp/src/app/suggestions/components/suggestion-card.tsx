 ...
 *
 * @param {Suggestion} suggestion - The suggestion object containing supervisor details,
 *
 */
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="max-w-full overflow-hidden">
                          <Link
                            ...
                            className="flex gap-2 items-start text-sm hover:underline decoration-foreground text-primary"
                          >
                            <File className="h-4 w-4 mt-0.5 text-foreground" />
                            <span className="flex-1 min-w-0 break-words leading-relaxed text-foreground">
