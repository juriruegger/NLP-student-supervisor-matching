export const content = {
  homepage: {
    title: `Welcome to SupervisorMatch!`,
    ...
    text2: `Our goal is to make the process of finding a supervisor as smooth and efficient as possible. 
    By leveraging NLP and a comprehensive database of research papers, we ensure that 
    you are paired with a supervisor who aligns with your research interests.`,

    text3: `Thank you for using our app to find your next supervisor. Please click 'begin' to fill out the form.`,
  },
  studentForm: {
    title: `Student Form`,
